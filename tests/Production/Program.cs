...
class Program
{
    ...
    static void Main()
    {
        ...
        var smelter=Add(1,"smelter");var crop=Add(2,"seedcarrot");Add(3,"rock",1000);
        ...
        ZDOMan.instance.all.Remove(crop.m_uid);var grown=Add(4,"carrot");ProductionAreas.Observe(grown);Advance(2);
        ...
        Add(6,"smelter");Advance(6);Check(ProductionAreas.Status.Contains("0 anchors"),"Prefab exclusion ignored");
        ZNetScene.instance=new(); Prefab("boar",new Tameable()); Prefab("egg",new EggGrow{m_tamed=true});
        var wild=Add(7,"boar",2000);var tame=Add(8,"boar",3000);tame.tamed=true;Add(9,"egg",3000);
